...
Some networks prefer a **PNG or JPEG** around **1200×630** instead of SVG. If previews look wrong, add `social.png` to the repo and change `og:image` / `twitter:image` to `__PICKMYPLACE_SITE__/social.png` (after you replace the token).
